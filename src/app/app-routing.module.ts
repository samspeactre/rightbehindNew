...
const routes: Routes = [
  ...
  { path: 'property-details', component: PropertyDetailsComponent, data:{footer:true} },
  { path: 'selling-detail', component: PropertyDetailsComponent, data:{footer:true} },
  { path: 'buy-property', component: PropertyDetailsComponent, data:{footer:true} },
  { path: 'listing', component: ListingsComponent },
  { path: 'popup', component: PopupComponent },
  { path: 'listing-page', component: ListingPageComponent, data:{footer:true} },
  { path: 'contact-us', component: ContactUsComponent, data:{footer:true} },
  { path: 'rent-preview', component: PreviewComponent, data:{footer:true} },
